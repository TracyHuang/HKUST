...
GLfloat rollAngle = 0.0;
GLfloat mv[16];   //used to store modelview matrix
...
void init(void)
{
	...
	gluLookAt(0.5, 0.0, 0.5, 0.0, 0.0, 0.5, 0.0, 0.0, 1.0);
}

void display(void)
{
	static GLfloat zShift = 0.0015; //fly
	...
	//gluLookAt(0.5, 0.0, 1.5, 0.0, 0.0, 1.5, 0.0, 0.0, 1.0);
	

	glGetFloatv(GL_MODELVIEW_MATRIX,mv);
	glLoadIdentity();
	glTranslatef(0,0,zShift);
